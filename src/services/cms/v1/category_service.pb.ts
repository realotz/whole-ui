...
export async function CreateCategory(params: ApiCmsV1.Category, options?: Options) {
  return request<ApiCmsV1.CreateCategoryReply>(
    APIService + '/api.cms.v1.CategoryService/CreateCategory',
    {
      method: 'POST',
      params: { ...params },
      ...(options || {}),
...
export async function UpdateCategory(params: ApiCmsV1.Category, options?: Options) {
  return request<ApiCmsV1.UpdateCategoryReply>(
    APIService + '/api.cms.v1.CategoryService/UpdateCategory',
    {
      method: 'POST',
      params: { ...params },
      ...(options || {}),
...
export async function DeleteCategory(params: ApiCmsV1.DeleteCategoryRequest, options?: Options) {
  return request<ApiCmsV1.DeleteCategoryReply>(
    APIService + '/api.cms.v1.CategoryService/DeleteCategory',
    {
      method: 'POST',
      params: { ...params },
      ...(options || {}),
...
export async function ListCategory(params: ApiCmsV1.ListCategoryRequest, options?: Options) {
  return request<ApiCmsV1.ListCategoryReply>(
    APIService + '/api.cms.v1.CategoryService/ListCategory',
    {
      method: 'POST',
      params: { ...params },
      ...(options || {}),
